      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="text-center py-10 sm:py-16">
          ...
          >
            ...
            <span className="text-[#E2F827] group-hover:underline decoration-4 underline-offset-8">Aja.</span>
          ...
          <p className="mt-5 text-xs sm:text-base text-gray-300 max-w-xl mx-auto font-light leading-relaxed px-2">
            Masih bingung mulai dari mana? Chat Aji aja. Ceritakan berangkat dari kota mana dan kapan kira-kira mau pergi. Nanti kita ngobrol soal rute, transit, hotel, dan paket yang cocok.
          </p>
